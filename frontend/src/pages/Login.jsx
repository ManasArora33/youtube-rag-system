    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="auth-card rounded-xl p-8">
          <h1 className="text-2xl font-semibold text-white mb-2 text-center tracking-tight">Welcome back</h1>
          <p className="text-neutral-500 text-sm text-center mb-8">Sign in to your account to continue</p>
          ...
          <p className="mt-6 text-center text-sm text-neutral-500">
            ...
            <Link to="/register" className="text-white hover:text-neutral-300 transition-colors font-medium">
              Create account
            </Link>
          </p>
        </div>
